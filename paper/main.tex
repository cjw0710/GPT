...
\caption{\method{} overview. A fixed split feeds self-loop and ego-separated residual experts trained under the same budget. A frozen validation-confidence rule selects one branch; test labels are used only after the choice is locked.}
